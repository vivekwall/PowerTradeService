...
namespace PowerTradeService.Services
{
    public class PowerTradeBusinessService : IPowerTradeBusinessService
    {
        ...
        public PowerTradeBusinessService()
        {
           // _logger = logger;
        }
        public async Task<List<PowerTradeResult>> GetTradesForPeriodAsync()
        {
            ...
            var powerServiceWrapper = new PowerServiceWrapper();

            var trades = await powerServiceWrapper.GetTradesAsync(DateTime.UtcNow.Date);
